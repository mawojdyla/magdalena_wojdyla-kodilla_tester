...
public class BMISources {
    static Stream<Arguments> provideDataForBMI() {
        return Stream.of(
                ...
                Arguments.of(1.63, 135, "Obese Class IV (Morbidly obese)"),
                Arguments.of(1.70, 49, "Severly underweight"),
                Arguments.of(1.70, 130, "Obese Class V (Super Obese)"),
                Arguments.of(1.85, 160, "Obese Class VI (Hyper Obese)"),
