...
public class RandomNumbers {
    ...
    private int min = Integer.MAX_VALUE; //  Zmienne prywatne: min, max, sum i random są zadeklarowane
    private int max = Integer.MIN_VALUE; // jako prywatne zmienne instancji, aby mogły być dostępne wewnątrz metod klasy.
