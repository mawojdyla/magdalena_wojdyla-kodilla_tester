...
public class Student {
    ...
    public Student(String name) {   // konstruktor inicjalizuje imię studenta i obiekty klasy 'Grades'
        this.name = name;
...
// Obliczanie średnich: Metody getGeographyAverage, getHistoryAverage, getMathsAverage i getPhysicsAverage
// w klasie Student wywołują metodę getAverage odpowiedniej instancji Grades,
// co pozwala obliczyć średnią ocen dla każdego przedmiotu.



    public double getAverage() {        // oblicza średnią ocen dla wszystkich przedmiotów, korzystając z metod getAverage() obiektów Grades
